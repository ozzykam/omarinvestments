      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => setTenantType('residential')}
            ...
            <button
              type="button"
              onClick={() => setTenantType('commercial')}
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium border transition-colors ${
        ...
        {tenantType === 'residential' && (
          <div className="space-y-4">
            ...
            <div className="space-y-4 pt-2">
              <h3 className="text-sm font-medium text-muted-foreground">Emergency Contact (optional)</h3>
        ...
        <div className="flex gap-3 pt-4">
          <button
            type="submit"
            disabled={loading || !propertyId || !email}
